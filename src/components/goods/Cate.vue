<template>
  <div>
    ...
    <el-dialog
      ...
      <el-form :model="addCateForm" :rules="addCateFormRules" ref="addCateFormRef" label-width="100px">
        ...
        <el-form-item label="父级分类：">
          <!-- options指定数据源 -->
          <!-- props指定配置对象 -->
          <el-cascader :options="parentCateList" :props="cascaderProps" v-model="selectedKeys" @change="parentCateChange" clearable></el-cascader>
        </el-form-item>
      </el-form>
      <span slot="footer">
    ...
    <el-dialog
      ...
      <el-form :model="cateInfo" :rules="editCateFormRules" ref="editCateFormRef" label-width="100px">
        <el-form-item label="分类名称" prop="cat_name">
...
export default {
  ...
  methods: {
    ...
    async removeCate(cate) {
      const confirmResult = await this.$confirm(`此操作将永久删除 ${cate.cat_name} 分类, 是否继续?`, '提示', {
